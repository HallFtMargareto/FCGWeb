  ...
  <div>
    <div class="search-term">
      <searchform size="mini" :maxShow="3" @search="onQuery">
              ...
              <el-input v-model="searchInfo.pin_yin_initial" placeholder="拼音首字母" clearable></el-input>
              ...
              <el-input v-model="searchInfo.quan_pin" placeholder="全拼" clearable></el-input>
              ...
              <el-input v-model="searchInfo.big_head_url" placeholder="大头像" clearable></el-input>
          
              </el-form-item> 
          
          
      
              <el-form-item label="小头像">
              <el-input v-model="searchInfo.small_head_url" placeholder="小头像" clearable></el-input>
    ...
    <el-table-column label="ID" prop="ID" sortable></el-table-column>
          ...
          <el-table-column label="用户唯一标识" prop="username" show-overflow-tooltip>
          </el-table-column> 
          ...
          <el-table-column label="拼音首字母" prop="pin_yin_initial" show-overflow-tooltip>
          </el-table-column> 
