        ...
        <div class="search-term">
            <searchform size="mini" :maxShow="4" @search="onQuery">
                ...
                <el-form-item label="彩票类型">
                    <GCategory v-model.number="searchInfo.game_category" placeholder="请输入游戏类别" clearable
        ...
        <div>
            <el-row :gutter="24">
                <el-col :span="6" v-if="statusTabState === '1' || statusTabState === '2' || mark_state === '1'">
                    ...
                    <el-button v-if="statusTabState === '2'" icon="el-icon-s-promotion"
                        :disabled="multipleSelection.length === 0" @click="handleBatchTransfer">
                        批量转出
                    </el-button>
                </el-col>
        ...
        <div class="card-container" v-if="groupedTableData">
            ...
            <el-card v-for="(orderGroup, index) in groupedTableData" :key="index" class="order-card"
                ...
                <div class="card-checkbox"
                    v-if="statusTabState === '1' || statusTabState === '2' || mark_state === '1'">
                    <el-checkbox v-model="orderGroup.selected"
                        @change="handleOrderSelectionChange(orderGroup)"></el-checkbox>
                </div>
                <!-- 订单功能区 -->
                <div class="card-title">
                    ...
                    <div class="right-content">
                        ...
                        <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" icon="el-icon-info"
                            icon-color="red" title="确定要撤销这个订单吗？" @confirm="deleteRow(orderGroup)"
                ...
                <div class="card-content">
                    ...
                    <div class="left-panel">
                        <el-descriptions :column="2" size="mini" border :labelStyle="{ width: '100px' }">
                            ...
                            <el-descriptions-item label="订单状态">
                                ...
                                <el-tag v-if="orderGroup.is_imme == 1" type="success" size="mini"
                    ...
                    <div class="right-panel">
                        <el-table :data="orderGroup.order_details" size="small" border style="width: 100%"
                            ...
                            <el-table-column prop="game_type_name" label="玩法" align="center"
                                show-overflow-tooltip></el-table-column>
            ...
            <div>
                <el-col>
                    <!-- 数据合计,按需求启用 -->
                    <!-- <el-button v-if="userInfo.perm['system.summary']" @click="getSummaryList">合计</el-button> -->
                    <el-pagination :current-page="page" :page-size="pageSize" :page-sizes="[10, 20]"
                        :style="{ float: 'right', padding: '0' }" :total="total" @current-change="handleCurrentChange"
