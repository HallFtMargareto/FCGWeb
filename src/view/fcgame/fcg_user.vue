  ...
  <div>
    <div class="search-term">
      <searchform size="mini" :maxShow="3" @search="onQuery">
              <el-form-item label="玩家登录名">
              <el-input v-model="searchInfo.username" placeholder="玩家登录名" clearable></el-input>
              ...
              <el-input v-model="searchInfo.nickname" placeholder="玩家昵称" clearable></el-input>
          
              </el-form-item> 
          
          
      
              <el-form-item label="玩家账户余额">
              <el-input v-model="searchInfo.balance" placeholder="玩家账户余额" clearable></el-input>
          
              </el-form-item> 
          
          
      
              <el-form-item label="账户状态 (1:正常, 2:冻结, 0:已删除)" prop="status">
    ...
    <el-table-column label="ID" prop="ID" sortable></el-table-column>
          ...
          <el-table-column label="玩家登录名" prop="username" show-overflow-tooltip>
          </el-table-column> 
        
      
          <el-table-column label="玩家昵称" prop="nickname" show-overflow-tooltip>
          </el-table-column> 
        
      
          <el-table-column label="玩家账户余额" prop="balance">
          </el-table-column> 
        
      
            <el-table-column label="账户状态 (1:正常, 2:冻结, 0:已删除)" prop="status">
    ...
    <dialogform
      ...
      ref="dialog"
    >
        <el-form-item label="玩家登录名" prop="username">
        ...
        <el-form-item label="玩家账户余额" prop="balance">
                    <el-input v-model="formData.balance" clearable placeholder="请输入" ></el-input>
        </el-form-item>
        <el-form-item label="账户状态 (1:正常, 2:冻结, 0:已删除)" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        username: [{ required: true, message: "请填写数据", trigger: "blur" }],nickname: [{ required: true, message: "请填写数据", trigger: "blur" }],
            balance: [{ required: true, message: "请选择项目", trigger: "change" }],
